...
const_C = [-1] * Target_num # loss for each quit of a normal user


# def bayesian_OSSP(B_now, expected_prob_catch, type, num_alerts_count, attacker_type):
def bayesian_OSSP_qr(prob_being_caught_list, attacker_type, num_alerts_count, lambda_p):
